...
<img src="/img/release_notes/token_preview.png" alt="Screen shot of token preview tab">
...
We improved some behaviors related for [base claim `amr`](/standards/OIDC/#base-claims-always-present):
