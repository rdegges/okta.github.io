...
{% image blog/serverless-holiday-cheer/create-function.png alt:"Create a new Lambda function" width:"700" %}{: .center-image }
...
{% image blog/serverless-holiday-cheer/test-function.png alt:"Successful function test" width:"700" %}{: .center-image }
...
{% image blog/serverless-holiday-cheer/new-api-gateway.png alt:"Create a new API Gateway API" width:"700" %}{: .center-image }
...
{% image blog/serverless-holiday-cheer/cheer-method-setup.png alt:"Define a method for the /cheer resource" width:"700" %}{: .center-image }
...
{% image blog/serverless-holiday-cheer/add-custom-domain-name.png alt:"Add a custom domain name" width:"500" %}{: .center-image }
...
{% image blog/serverless-holiday-cheer/cname-record.png alt:"Add a custom domain name" width:"700" %}{: .center-image }
...
{% image blog/serverless-holiday-cheer/post-with-postman.png alt:"Add a custom domain name" width:"700" %}{: .center-image }
